...
import { Images, Sparkles, LayoutGrid } from "lucide-react";
        ...
        <div className="relative z-10 py-16 md:py-24 lg:py-32">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <FadeIn delay={0.3}>
              <p className="mx-auto mt-6 max-w-2xl text-lg leading-relaxed text-white/50 md:text-xl">
                Explore our work through interactive visual experiences
              </p>
            </FadeIn>
          </div>
          ...
          <div className="pointer-events-none absolute inset-0 overflow-hidden">
            ...
            <MotionDiv
              ...
              className="absolute left-[10%] top-[40%] text-cyan-500/20"
            >
            ...
            <MotionDiv
              ...
              className="absolute left-[20%] top-[15%] text-blue-500/15"
            >
