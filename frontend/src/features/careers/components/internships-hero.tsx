...
const stats = [
  { label: "Programs", value: "8", icon: Briefcase },
  { label: "Duration", value: "6 Months", icon: Clock },
  { label: "Conversion Rate", value: "90%", icon: TrendingUp },
];
  ...
  return (
    <Section padding="lg">
      <div className="pointer-events-none absolute inset-0 overflow-hidden">
        ...
        <div className="absolute left-1/2 top-0 h-60 w-60 -translate-x-1/2 rounded-full bg-cyan-500/10 blur-[120px]" />
      </div>
          ...
          <div className="mx-auto mt-8 max-w-4xl text-center">
            ...
            <FadeIn delay={0.4}>
              <p className="mx-auto mt-6 max-w-2xl text-lg leading-relaxed text-white/50 md:text-xl">
                Join our internship programs and work on real projects alongside
                industry veterans. Build your portfolio, gain mentorship, and
          ...
          <FadeIn delay={0.5}>
            <div className="mx-auto mt-16 grid max-w-3xl grid-cols-1 gap-4 sm:grid-cols-3">
              {stats.map((stat) => (
                ...
                >
                  <stat.icon className="mb-3 h-5 w-5 text-purple-400 transition-colors group-hover:text-purple-300" />
