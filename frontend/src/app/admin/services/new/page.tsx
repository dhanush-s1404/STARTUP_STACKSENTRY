...
export default function NewServicePage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      const result = await adminApi.createService(data);
      router.push(`/admin/services/${result.slug}`);
    } catch (err) {
    ...
    <div>
      <div className="mb-6 flex items-center gap-4">
        ...
        <div>
          ...
          <p className="mt-1 text-white/40">Create a new service offering</p>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit} className="max-w-3xl space-y-6">
        ...
        <div className="rounded-xl border border-white/[0.06] bg-white/[0.02] p-6">
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            ...
            <div className="space-y-1.5">
              <label className="text-sm font-medium text-white/80">FAQ (JSON)</label>
              <textarea
                name="faq"
                value={form.faq}
                onChange={handleChange}
